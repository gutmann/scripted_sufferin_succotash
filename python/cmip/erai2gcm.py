...
gcm_varnames=["hus","ps","rh","ta","ua","va"]
erai_varnames=["Q_GDS4_ISBL_S123","LNSP_GDS4_HYBL_S123","R_GDS4_ISBL_S123","T_GDS4_ISBL_S123","U_GDS4_ISBL_S123","V_GDS4_ISBL_S123"]
erai_fileprefixes=["SC","PS","SC","SC","UV","UV"]
...
def write_output(outputfile,data,geo):
    ...
    print(latdim,geo.lat.shape)
    print(londim,geo.lon.shape)
    print(pdim,geo.p.shape)
    ...
    mygis.write(outputfile,data=geo.p,varname="p",dtype="f",attributes=patts,dims=pdim,
                history="Data generated by cmip/era2gcm.py",extravars=vardata)
...
def main(gcm="ccsm"):
    ...
    for month in range(1,13):
        ...
        pLUT=bilin_regrid.load_vLUT(erai_geo.p,gcm_geo.p)
